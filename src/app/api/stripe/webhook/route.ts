...
Asunto: Confirmación de pago y reserva - Concierto Cantar del Alma
Cuerpo:
Estimado/a ${reserva.nombre},

Hemos recibido correctamente el pago de su reserva para el concierto 'Cantar del Alma' que tendrá lugar el Domingo, 22 de Noviembre de 2026.
...
Su entrada digital ha sido registrada. Presente esta confirmación al ingresar al Ateneo de Madrid.
...
Asunto: ¡NUEVA RESERVA INFORMADA! - Concierto Cantar del Alma
Cuerpo:
Hola José Manuel,

Se ha confirmado el pago de una nueva reserva para el concierto Cantar del Alma.
            ...
            try {
                ...
                if (bodyObj.action === "simulate_success" && bodyObj.reservaId) {
                    ...
                    await prisma.pagosUsuario.create({
                        data: {
                            codigoViaje: "CANTAR_DEL_ALMA_NOV_2026",
                            fechaSalida: new Date("2026-11-22"),
                            idusuario: user.idusuario,
                            descripcionViaje: `Pago del concierto registrado físicamente (${checkoutAmount} €)`,
            ...
            case "checkout.session.completed": {
                ...
                await prisma.pagosUsuario.create({
                    data: {
                        ...
                        fechaSalida: new Date("2026-11-22"),
                        idusuario: user.idusuario,
                        descripcionViaje: `Pago del concierto vía Stripe`,
                        cantidadAbonada: checkoutAmount,
                        procesado: "N",
